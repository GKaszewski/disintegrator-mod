...
public class ModBlocks {
    public static final Block DISINTEGRATOR = registerBlock("disintegrator", new DisintegratorBlock(FabricBlockSettings.copyOf(Blocks.STONE).strength(1.0f)), ItemGroups.REDSTONE);
